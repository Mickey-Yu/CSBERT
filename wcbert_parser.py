...
def get_argparse():
    ...
    parser.add_argument("--data_dir", default="data/dataset/NER/weibo", type=str, help="The input data dir")   #****** need my change
    ...
    parser.add_argument("--fusion_method", default='cosi', type=str, 
                        help="select in [straight_add, cosi, attention, sharpe_attention, gumbel_softmax]")
