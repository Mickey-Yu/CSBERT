...
def get_corpus_matched_word_from_lexicon_tree(files, lexicon_tree): # files=[train_data_file, dev_data_file, test_data_file]
    """
...
def build_lexicon_tree_from_vocabs(vocab_files, scan_nums=None): # vocab_files="data/vocab/tencent_vocab.txt", scan_nums=1000000
    # 1.获取词汇表
    print(vocab_files)
    vocabs = set()
    if scan_nums is None:
